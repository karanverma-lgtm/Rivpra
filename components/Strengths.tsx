...
const ROWS: { ml: number; cells: CellData[] }[] = [
  {
    ml: (W + GAP) / 2,
    cells: [
      { type: "strength", num: "01", title: "Robust Infrastructure",      desc: "3600 sq.ft facility in Sidcul, Haridwar.",  accent: "#1fb8e5" },
      { type: "image",    src: "/image_16.jpg", alt: "Rivpra Facility" },
      { type: "strength", num: "02", title: "Innovative Drug Delivery",   desc: "Solutions, Suspensions & Tablets.",           accent: "#f6b11b" },
    ],
  },
  {
    ml: 0,
    cells: [
      { type: "strength", num: "03", title: "In-House Formulation",       desc: "Research – Formulation – Delivery.",          accent: "#ddd82a" },
      { type: "image",    src: "/image_17.jpg", alt: "Rivpra Lab" },
      { type: "image",    src: "/image_18.jpg", alt: "Rivpra Production" },
      { type: "strength", num: "04", title: "Approved Products",          desc: "Approved by Key Regulatory Agencies.",        accent: "#f6b11b" },
    ],
  },
  {
    ml: (W + GAP) / 2,
    cells: [
      { type: "strength", num: "05", title: "WHO-cGMP & ISO 9001:2015",  desc: "Globally certified pharmaceutical company.",  accent: "#1fb8e5" },
      { type: "image",    src: "/image_19.jpg", alt: "Rivpra Quality" },
      { type: "strength", num: "06", title: "24×7 Support",              desc: "Formulation · Production · Logistics.",       accent: "#f6b11b" },
    ],
  },
  {
    ml: W + GAP,
    cells: [
      { type: "strength", num: "07", title: "In-House Laboratory",       desc: "Advanced in-house development & testing.",    accent: "#ddd82a" },
      { type: "strength", num: "08", title: "Zero Defect",               desc: "Customer-centric quality approach.",          accent: "#f6b11b" },
    ],
  },
];
    ...
    return (
      <motion.div {...baseAnim} className="relative flex-shrink-0" style={{ width: W, height: H }}>
        ...
        <div
          ...
          style={{ clipPath: CLIP, background: "linear-gradient(135deg,#1fb8e550,#f6b11b40)" }}
        />
        {/* image */}
  ...
  return (
    <motion.div {...baseAnim} className="group relative flex-shrink-0" style={{ width: W, height: H }}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-7 text-center">
        ...
        <span className="mb-2 text-[13px] font-bold leading-snug text-slate-950">
          {cell.title}
        </span>
        <span className="text-[10px] font-light leading-snug text-slate-500">
          {cell.desc}
        </span>
...
export default function Strengths() {
  ...
  return (
    <section id="strengths" className="relative w-full overflow-hidden bg-white py-12">
      ...
      />
      <div className="pointer-events-none absolute left-1/4 top-0 h-80 w-80 -translate-x-1/2 rounded-full bg-[#1fb8e5]/10 blur-[110px]" />
      <div className="pointer-events-none absolute bottom-0 right-1/4 h-80 w-80 rounded-full bg-[#f6b11b]/8 blur-[110px]" />
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-slate-950 lg:text-6xl">
            Our{" "}
        ...
        <div className="grid grid-cols-2 gap-4 md:hidden">
          {MOBILE.map((item, i) => (
            ...
            >
              ...
              <h3 className="mt-1 text-sm font-bold leading-tight text-slate-950">{item.title}</h3>
