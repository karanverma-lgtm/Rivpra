...
export default function Services() {
  ...
  return (
    <section id="services" className="relative w-full overflow-hidden bg-white py-32">
      ...
      {/* Glow blobs */}
      <div className="pointer-events-none absolute -left-40 top-1/3 h-80 w-80 rounded-full bg-[#1fb8e5]/10 blur-[120px]" />
      <div className="pointer-events-none absolute -right-40 bottom-1/3 h-80 w-80 rounded-full bg-[#f6b11b]/8 blur-[100px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div ref={ref} className="mb-20">
          <motion.span
            ...
            className="inline-block px-3 py-1 rounded-full border border-[#1fb8e5]/40 bg-[#1fb8e5]/10 text-[#f6b11b] text-xs font-semibold tracking-widest uppercase mb-6"
          >
            Therapy Areas
          </motion.span>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <motion.h2
              ...
              className="text-4xl lg:text-6xl font-black text-slate-950 leading-tight max-w-xl"
            >
              Our{" "}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {products.map((product, i) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-slate-200 bg-white p-6 overflow-hidden cursor-default transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:bg-slate-50"
            >
              {/* Top accent bar */}
              <div
              ...
              {/* Image */}
              <div className="relative mb-5 h-20 w-20 overflow-hidden rounded-2xl border border-slate-200">
                <Image
                  src={product.image}
                  alt={product.title}
                  fill
              ...
              {/* Title */}
              <h3 className="text-slate-950 font-bold text-base mb-2 leading-snug">
                {product.title}
              </h3>

              {/* Desc */}
              <p className="text-slate-500 text-xs leading-relaxed mb-5 font-light">
                {product.desc}
              </p>
